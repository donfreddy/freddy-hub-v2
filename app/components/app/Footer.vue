  ...
  <footer class="">
    ...
    >
      ...
      <ul class="flex flex-wrap mb-3 space-x-3 sm:mb-0">
        ...
        <li>
          <a
            href="https://www.linkedin.com/in/don-freddy-237ba4193"
            target="_blank"
            class="social-icon"
          >
            <svg
        ...
        <!-- Github -->
        <li>
          <a href="https://github.com/donfreddy" target="_blank" class="social-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              class="w-5"
        ...
        <!-- Twitter -->
        <li>
          <a href="https://twitter.com/dfreddydev" target="_blank" class="social-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              class="w-5"
